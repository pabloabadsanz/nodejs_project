...
cli.responders.help = function() {
  var commands = {
    ...
    'list users': 'Show all the list of all the registered users in the system',
    'more user info --{userId}': 'Show details of a specific user',
    'list checks --up --down': 'Show a list of all the active checks in the system, including their state. Both flags are optional',
...
cli.responders.moreLogInfo = function(str) {
  // Get the logFileName from the string provided to us
  var arr = str.split('--');
